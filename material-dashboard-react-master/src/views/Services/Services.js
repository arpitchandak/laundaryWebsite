...
deleteButton(cell){
  console.log(cell)
  fetch('https://laundry-freelance.herokuapp.com/admin/delete/service/'+cell, {
     method: 'DELETE',
     headers:{
      'Content-Type' : 'application/json',
      'Accept':'application/json'
    ...
    const options = {
      ...
      return (
          ...
          <GridItem xs={12} sm={12} md={12}>
            <Card>
              <CardHeader color="primary">
                <h4 className={styles.cardTitleWhite}>Service Types</h4>
                ...
                /> */}
                    ...
                    >
                        ...
                        <Modal.Body>
                                ...
                                <Form.Group controlId="exampleForm.ControlInput1">
                                    <Form.Label>Turkish Service Name</Form.Label>
       ...
       autoCollapse={true}
              ...
              <TableHeaderColumn  width='30%'>Type</TableHeaderColumn>
