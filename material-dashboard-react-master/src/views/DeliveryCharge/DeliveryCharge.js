...
export default class DeliveryCharge extends React.Component {
  constructor(props){
    super(props)
      ...
      return (
        <GridContainer>
          <GridItem xs={12} sm={12} md={12}>
            ...
            <h4 className={styles.cardTitleWhite}>Delivery Charges</h4>
            <p className={styles.cardCategoryWhite}>
              List of all Delivery charges
            </p>
          </CardHeader>
...
<Button onClick={() => {this.setState({
         ...
         autoCollapse={true}
            //   data={ this.state.services }
              ...
              <TableHeaderColumn dataField='question' >Min. Distance</TableHeaderColumn>
              <TableHeaderColumn dataField='answer'  >Max. Distance</TableHeaderColumn>  
               <TableHeaderColumn dataField='status'  >Charge</TableHeaderColumn>
