...
componentDidMount(){
    ...
    fetch('https://scenic-lassen-volcanic-38075.herokuapp.com/privacy', {
        method: 'GET',
        })
  ...
  editButton(cell){
    ...
    if (this.state.title == "" || this.state.title== null || this.state.description == "" || this.state.description== null|| this.state.status == '' || this.state.status== null) {
        ...
        // if (a) {
          ...
          fetch('https://scenic-lassen-volcanic-38075.herokuapp.com/privacy/'+cell, {
          method: "PATCH",
          headers:{
              'Content-Type' : 'application/json',
              'Accept':'application/json'
          ...
          <GridItem xs={12} sm={12} md={12}>
            <Card>
              <CardHeader color="primary">
                <h4 classque={styles.cardTitleWhite}>Privacy Policy</h4>
  ...
  return (
    <GridContainer>
      <GridItem xs={12} sm={12} md={12}>
        <Card>
          <CardHeader color="primary">
            <h4 className={styles.cardTitleWhite}>Privacy Policy</h4>
